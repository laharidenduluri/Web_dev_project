...
const categoryOptions = ['kurtas','Tops', 'Bottoms', 'Dresses and Jumpsuits', 'Shoes', 'Accessories','kurtis'];
...
const NewItemForm = ({ onCloseForm }) => {
    ...
    const handleFormChange = (event) => {
        ...
        if (name === 'category') {
            switch (value) {
                case "Tops":
                    setSubcategories(['kurtas','Blouses', 'Shirts', 'Sweaters', 'Tank Tops', 'T-shirts', 'Sweatshirts', 'Coats & Jackets','kurtis']);
